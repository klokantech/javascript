...
/**
 * @typedef {{controls: (ol.Collection.<ol.control.Control>|Array.<ol.control.Control>|undefined), pixelRatio: (number|undefined), interactions: (ol.Collection.<ol.interaction.Interaction>|Array.<ol.interaction.Interaction>|undefined), keyboardEventTarget: (Element|Document|string|undefined), layers: (Array.<ol.layer.Base>|ol.Collection.<ol.layer.Base>|undefined), loadTilesWhileAnimating: (boolean|undefined), loadTilesWhileInteracting: (boolean|undefined), logo: (boolean|string|olx.LogoOptions|Element|undefined), moveTolerance: (number|undefined), overlays: (ol.Collection.<ol.Overlay>|Array.<ol.Overlay>|undefined), renderer: (string|Array.<string>|undefined), target: (Element|string|undefined), view: (ol.View|undefined)}}
 */
olx.MapOptions;
...
/**
 * @typedef {{code: (string), units: (string|string|undefined), extent: (ol.Extent|undefined), axisOrientation: (string|undefined), global: (boolean|undefined), metersPerUnit: (number|undefined), worldExtent: (ol.Extent|undefined), getPointResolution: (Function|undefined)}}
 */
...
/**
 * @typedef {{center: (ol.Coordinate|undefined), zoom: (number|undefined), resolution: (number|undefined), rotation: (number|undefined), anchor: (ol.Coordinate|undefined), duration: (number|undefined), easing: (undefined|Function), undefined: (Object)}}
 */
...
/**
 * @typedef {{resolution: (number), start: (number|undefined), duration: (number|undefined), easing: (undefined|Function), undefined: (Object)}}
 */
...
/**
 * @typedef {{className: (string|undefined), minWidth: (number|undefined), render: (Function|undefined), target: (Element|string|undefined), units: (string|string|undefined)}}
 */
...
/**
 * @typedef {{className: (string|undefined), target: (Element|string|undefined), label: (string|Node|undefined), tipLabel: (string|undefined), extent: (ol.Extent|undefined), undefined: (Object)}}
 */
...
/**
 * @typedef {{factor: (number|undefined), geometryLayout: (string|undefined)}}
 */
...
/**
 * @typedef {{altitudeMode: (string|undefined)}}
 */
...
/**
 * @typedef {{clickTolerance: (number|undefined), features: (ol.Collection.<ol.Feature>|undefined), source: (ol.source.Vector|undefined), snapTolerance: (number|undefined), type: (string|string), stopClick: (boolean|undefined), maxPoints: (number|undefined), minPoints: (number|undefined), finishCondition: (ol.EventsConditionType|undefined), style: (ol.style.Style|Array.<ol.style.Style>|ol.StyleFunction|undefined), geometryFunction: (ol.DrawGeometryFunctionType|undefined), geometryName: (string|undefined), condition: (ol.EventsConditionType|undefined), freehand: (boolean|undefined), freehandCondition: (ol.EventsConditionType|undefined), wrapX: (boolean|undefined)}}
 */
...
/**
 * @typedef {{attributions: (ol.AttributionLike|undefined), canvasFunction: (ol.CanvasFunctionType), logo: (string|olx.LogoOptions|undefined), projection: (ol.ProjectionLike), ratio: (number|undefined), resolutions: (Array.<number>|undefined), state: (string|undefined)}}
 */
...
/**
 * @typedef {{sources: (Array.<ol.source.Source>), operation: (ol.RasterOperation|undefined), lib: (Object|undefined), threads: (number|undefined), operationType: (string|undefined)}}
 */
olx.source.RasterOptions;


/**
 * @typedef {{attributions: (ol.AttributionLike|undefined), crossOrigin: (null|string|undefined), hidpi: (boolean|undefined), serverType: (string|undefined), imageLoadFunction: (ol.ImageLoadFunctionType|undefined), logo: (string|olx.LogoOptions|undefined), params: (Object.<string, *>), projection: (ol.ProjectionLike), ratio: (number|undefined), resolutions: (Array.<number>|undefined), url: (string|undefined)}}
 */
...
/**
 * @typedef {{attributions: (ol.AttributionLike|undefined), cacheSize: (number|undefined), params: (Object.<string, *>), crossOrigin: (null|string|undefined), gutter: (number|undefined), hidpi: (boolean|undefined), logo: (string|olx.LogoOptions|undefined), tileClass: (Function|undefined), tileGrid: (ol.tilegrid.TileGrid|undefined), projection: (ol.ProjectionLike), reprojectionErrorThreshold: (number|undefined), serverType: (string|undefined), tileLoadFunction: (ol.TileLoadFunctionType|undefined), url: (string|undefined), urls: (Array.<string>|undefined), wrapX: (boolean|undefined), transition: (number|undefined)}}
 */
...
/**
 * @typedef {{attributions: (ol.AttributionLike|undefined), cacheSize: (number|undefined), crossOrigin: (string|null|undefined), logo: (string|olx.LogoOptions|undefined), tileGrid: (ol.tilegrid.WMTS), projection: (ol.ProjectionLike), reprojectionErrorThreshold: (number|undefined), requestEncoding: (Object|string|undefined), layer: (string), style: (string), tileClass: (Function|undefined), tilePixelRatio: (number|undefined), version: (string|undefined), format: (string|undefined), matrixSet: (string), dimensions: (Object|undefined), url: (string|undefined), tileLoadFunction: (ol.TileLoadFunctionType|undefined), urls: (Array.<string>|undefined), wrapX: (boolean|undefined), transition: (number|undefined)}}
 */
...
/**
 * @typedef {{exceedLength: (boolean|undefined), font: (string|undefined), maxAngle: (number|undefined), offsetX: (number|undefined), offsetY: (number|undefined), overflow: (boolean|undefined), scale: (number|undefined), rotateWithView: (boolean|undefined), rotation: (number|undefined), text: (string|undefined), textAlign: (string|undefined), textBaseline: (string|undefined), fill: (ol.style.Fill|undefined), stroke: (ol.style.Stroke|undefined), backgroundFill: (ol.style.Fill|undefined), backgroundStroke: (ol.style.Stroke|undefined), padding: (Array.<number>|undefined)}}
 */
olx.style.TextOptions;


/**
 * @typedef {{geometry: (undefined|string|ol.geom.Geometry|ol.StyleGeometryFunction), fill: (ol.style.Fill|undefined), image: (ol.style.Image|undefined), renderer: (ol.StyleRenderFunction|undefined), stroke: (ol.style.Stroke|undefined), text: (ol.style.Text|undefined), zIndex: (number|undefined), undefined: (Object)}}
 */
...
/**
 * @typedef {string|Array.<string>|Object}
 */
ol.AttributionLike;
